...
function SmartWizard(target, options) {
    ...
    SmartWizard.prototype.enableFinish = function (enable) {
        // Controll status of finish button dynamically, just call this with status you want
    ...
    SmartWizard.prototype.destroyWizard = function () {
        var parent = $(this.target).parent();
        $(this.target).remove();
        $(this.target).unbind();
        $(parent).append(this.targetClone);
    };
